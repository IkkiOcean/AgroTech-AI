...
from sugarcane_prediction import predict_sugarcane  # Importing the prediction function
from paddy_prediction import predict_paddy  # Importing the prediction function
...
CLASS_LABELS2 = ['Healthy', 'Mosaic', 'RedRot', 'Rust', 'Yellow']
